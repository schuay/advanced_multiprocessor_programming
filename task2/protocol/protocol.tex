...
\begin{comment}
None of the following are actually mistakes in the book, since they provide the
algorithm in Java (which obviously has GC). A potential mistake is that they
simply access a bucket without a lock in relocate().
\end{comment}
