...
was taken for each value\footnote{With the exception of the \emph{Striped
...
\emph{Striped Cuckoo Set} implementation with a 2x1024 locks and our
...
and this set of benchmarks contains many more \lstinline|add()| calls.

Perhaps a surprising point was how much performance was affected by using
